...
static const uint32_t phyInfo[] = {
  17UL,
  0x00348348UL, // 52.51282051282051
  (uint32_t) NULL,
...
const uint32_t Protocol_Configuration_modemConfigBase[] = {
  ...
  /*    C0D4 */ 0x000A0001UL,
  /*    C0D8 */ 0x00280001UL,
  0x01010008UL, 0x000007ACUL,
  0x01010018UL, 0x00000000UL,
  0x01010020UL, 0xD5828281UL,
  0x01264040UL, 0x21900000UL,
  /*    4044 */ 0x00000000UL,
  /*    4048 */ 0x00000010UL,
  /*    404C */ 0x04000000UL,
  /*    4050 */ 0x0082C00FUL,
