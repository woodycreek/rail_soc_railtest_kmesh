...
#ifndef SL_CLI_CONFIG_INST0_H
#define SL_CLI_CONFIG_INST0_H

/*******************************************************************************
 ******************************   DEFINES   ************************************
 ******************************************************************************/

// <o SL_CLI_INST0_TASK_PRIORITY> CLI instance task priority
...
// <i> Priority of the CLI instance task using the CMSIS order and using the enum name
  #define SL_CLI_INST0_TASK_PRIORITY      osPriorityNormal1

// <o SL_CLI_INST0_TASK_STACK_SIZE> Task stack size
// <i> Default: 400
// <i> Stack size for the CLI task in words.
  #define SL_CLI_INST0_TASK_STACK_SIZE       400

// <o SL_CLI_INST0_TASK_START_DELAY_MS> CLI task start delay
// <i> Default: 0
// <i> Specifies the delay in milliseconds before the cli task start to poll for input.
  #define SL_CLI_INST0_TASK_START_DELAY_MS   0

// <o SL_CLI_INST0_TASK_LOOP_DELAY_MS> CLI task loop delay
// <i> Default: 50
// <i> Specifies the delay in milliseconds after the cli task has polled the input.
  #define SL_CLI_INST0_TASK_LOOP_DELAY_MS    50

// <o SL_CLI_INST0_IOSTREAM_HANDLE> The iostream handle used by the cli instance
// <i> Default: sl_iostream_get_default()
  #define SL_CLI_INST0_IOSTREAM_HANDLE    sl_iostream_vcom_handle

// <o SL_CLI_INST0_COMMAND_GROUP> The default command group.
...
// <i> Please note: A command group can only be used once.
  #define SL_CLI_INST0_COMMAND_GROUP      sl_cli_default_command_group

#endif // SL_CLI_CONFIG_INST0_H
